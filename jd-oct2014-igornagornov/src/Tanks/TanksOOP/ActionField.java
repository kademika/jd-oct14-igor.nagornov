...
public class ActionField extends JPanel {
	...
	void processClean(Tank tank) throws Exception { // если есть кирпичи в
		...
		int[] distances = { distanceUp, distanceDown, distanceLeft, distanceRight };
	...
	public boolean processInterception() { // функция проверяет столкновение
											// пули с препятствием, если да, то
											// кирпич взрывается
	...
	public boolean processCollision(Tank tank) { // проверяет, столкнулся ли
		...
		if ((tank.getDirection() == 1 && tank.getY() != 0)
				|| (tank.getDirection() == 2 && tank.getY() < 512)
				|| (tank.getDirection() == 3 && tank.getX() != 0)
				|| (tank.getDirection() == 4 && tank.getX() < 512)) {
